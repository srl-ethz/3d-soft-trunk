...
private:
     ...
     */
    std::array<double, st_params::num_segments> shear_modulus = {63000., 57000}; /** the results from characterization was 29747 for top but that's probably underestimated due to gravity */
    std::array<double, st_params::num_segments> drag_coef = {46000., 8000.};
